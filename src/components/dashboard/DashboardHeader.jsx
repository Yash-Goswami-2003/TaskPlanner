...
export default function DashboardHeader({ user }) {
  ...
  return (
    <header className="h-[65px] bg-white border-b border-neutral-200 px-6 flex items-center justify-between sticky top-0 z-40">
      {/* Brand & Organization */}
      <div className="flex items-center gap-4">
        <Link href="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-lg bg-neutral-900 flex items-center justify-center text-white font-bold text-sm shadow-2xs group-hover:bg-neutral-800 transition">
            T
          </div>
